 ...
 * Defaults to "short" and uses PIE_CACHE_RETENTION with PI_CACHE_RETENTION as a legacy fallback.
 */
function resolveCacheRetention(cacheRetention?: CacheRetention, env?: ProviderEnv): CacheRetention {
	if (cacheRetention) {
		return cacheRetention;
	}
	if ((getProviderEnvValue("PIE_CACHE_RETENTION", env) ?? getProviderEnvValue("PI_CACHE_RETENTION", env)) === "long") {
		return "long";
	}
	return "short";
}
