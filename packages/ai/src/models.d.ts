...
type ModelApi<TProvider extends KnownProvider, TModelId extends keyof (typeof BUILT_IN_MODELS)[TProvider]> = (typeof BUILT_IN_MODELS)[TProvider][TModelId] extends {
    api: infer TApi;
} ? TApi extends Api ? TApi : never : never;
export declare function getModel<TProvider extends KnownProvider, TModelId extends keyof (typeof BUILT_IN_MODELS)[TProvider]>(provider: TProvider, modelId: TModelId): Model<ModelApi<TProvider, TModelId>>;
export declare function getProviders(): KnownProvider[];
export declare function getModels<TProvider extends KnownProvider>(provider: TProvider): Model<ModelApi<TProvider, keyof (typeof BUILT_IN_MODELS)[TProvider]>>[];
