...
export const streamClaudeAgentSdk: StreamFunction<"claude-agent-sdk", ClaudeAgentSdkOptions> = (
...
export const streamSimpleClaudeAgentSdk: StreamFunction<"claude-agent-sdk", SimpleStreamOptions> = (
	model: Model<"claude-agent-sdk">,
	context: Context,
	options?: SimpleStreamOptions,
): AssistantMessageEventStream => {
	return streamClaudeAgentSdk(model, context, options as ClaudeAgentSdkOptions);
};
