...
- Built-in: `dark`, `light`
- Global: `~/.pie/agent/themes/*.json`
- Project: `.pie/themes/*.json` (only after the project is trusted)
...
```bash
mkdir -p ~/.pie/agent/themes
vim ~/.pie/agent/themes/my-theme.json
```
...
```json
{
  "$schema": "https://raw.githubusercontent.com/jikime/pie-lab/main/packages/coding-agent/src/modes/interactive/theme/theme-schema.json",
  "name": "my-theme",
  "vars": {
    "primary": "#00aaff",
    "secondary": 242
