import { CustomEditor, type ExtensionAPI, type ExtensionContext, type KeybindingsManager } from "@pie-lab/coding-agent";
import type { Component, EditorTheme, TUI } from "@pie-lab/tui";
import { truncateToWidth, visibleWidth } from "@pie-lab/tui";
