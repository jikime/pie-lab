...
import { DynamicBorder, getAgentDir } from "@pie-lab/coding-agent";
import { Container, Key, type SelectItem, SelectList, Text } from "@pie-lab/tui";
...
function loadPresets(cwd: string): PresetsConfig {
	...
	const projectPath = join(cwd, ".pie", "presets.json");
