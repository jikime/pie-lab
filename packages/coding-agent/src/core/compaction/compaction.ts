...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@pie-lab/agent-core";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@pie-lab/ai/compat";
import { completeSimple } from "@pie-lab/ai/compat";
import {
	convertToLlm,
