...
import { type Api, type KnownProvider, type Model, modelsAreEqual } from "@pie-lab/ai";
...
export const defaultModelPerProvider: Record<KnownProvider, string> & Record<string, string> = {
