...
const cronJobSchema = Type.Object({
	...
	repeatTimes: Type.Optional(Type.Number({ description: "Stop after this many runs (repeating jobs only)." })),
	...
	skills: Type.Optional(
		Type.Array(Type.String(), { description: "Skill names loaded into the job prompt at fire time." }),
	),
