...
import { AuthStorage, type OAuthCredential } from "@pie-lab/coding-agent";
...
export function getRadiusAccessToken(): string {
	...
	throw new Error("Radius credentials are required in ~/.pie/agent/auth.json or PI_RADIUS_API_KEY");
}
