...
Reusable web UI components for building AI chat interfaces powered by [@pie-lab/ai](../ai) and [@pie-lab/agent-core](../agent).
...
```bash
npm install @pie-lab/web-ui @pie-lab/agent-core @pie-lab/ai
```
...
declare module '@pie-lab/agent-core' {
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@pie-lab/web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@pie-lab/web-ui';
...
```typescript
import { createExtractDocumentTool } from '@pie-lab/web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@pie-lab/web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@pie-lab/web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@pie-lab/web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@pie-lab/web-ui';
...
```typescript
import { SessionListDialog } from '@pie-lab/web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@pie-lab/web-ui';
...
```typescript
import { ModelSelector } from '@pie-lab/web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@pie-lab/web-ui';
