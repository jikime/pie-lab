...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".pie/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".pie/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.pie/agent/sessions)
